...
public void select(String code_qr){
	...
	try
	{
		...
		String request        = "http://192.168.1.7:80/miniprojetphp/select.php";
    ...
    catch(Exception e)
{
	...
	for(int i=0; i<jArray.length();i++){
		...
		mp3Url=json.getString("mp3Url");
		mapUrl=json.getString("mapUrl");
		code_qr=" "+json.getString("code_qr");
	}   
	Log.e("Pass", "SUccess !!");
	}
    catch(Exception e)
	{
    	Log.e("Fail 3 line AAAAAAAAA 207", e.toString());
	}			
}
}
